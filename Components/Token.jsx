          ...
          <div className="col-lg-5 mt-30">
            <div className="token__content wow fadeInLeft">
              <div className="sec-title mb-20">
                <h5 className="sec-title__subtitle">TokenNomics</h5>
              ...
              <ul className="nav nav-tabs token__tab" id="myTab" role="tablist">
                ...
                <li className="nav-item" role="presentation">
                  <button
                    ...
                    aria-selected="false" // Corrected the aria-selected attribute
                  >
                    Token Allocation
                  </button>
                </li>
              ...
              <div className="token__info mt-40">
                <h2>1 CNL = 0.00000013 BTC</h2>
                <p>
                  Lorem ipsum, dolor sit amet, consectetur adipisicing elit. 
                  Impedit sunt quam enim iure autem quis provident placeat aliquid, 
                  ex doloribus animi facere? Quia!
                </p>
